...
# Se establece una prueba de hipótesis, en donde
#H0: mu= 1 ; H1: mu != 1

t.test(bootstrap, alternative = "two.sided", mu = 1)

#¡p-valor < 0.05, por lo tanto, se rechaza la hipótesis nula. ES DECIR, LAS VARIABLES SON DEPENDIENTES
